...
const Dashboard = () => {
  ...
  const fetchUser = async () => {
    try {
      const response = await axios.get('http://linksphere-backend-k60s.onrender.com/api/auth/me');
  ...
  const fetchRooms = async () => {
    try {
      const response = await axios.get('http://linksphere-backend-k60s.onrender.com/api/rooms/my-rooms');
